...
One project with folders by concern, mirroring `/executor`, which is one package with modules. It deliberately has no ability to execute submitted code: it delegates to the executor over HTTP and stores what comes back.
